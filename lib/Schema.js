        ...
        change       : function (name) {
            ...
            function changeField(srcField, dstField) {
                ...
                if (srcField.autoIncrement) {
                    query.push('	' + quoteName(dstField.name) + ' ' + quote(srcField.name) + ' ' + srcField.type + ' auto_increment');
                }
                else if (srcField.type === 'varchar') {
                    query.push('	' + quoteName(dstField.name) + ' ' + quoteName(srcField.name) + ' varchar(' + srcField.size + ')');
                }
                else {
                    query.push('	' + quoteName(dstField.name) + ' ' + quoteName(srcField.name) + ' ' + srcField.type);
                }
                SQL.update(query);
            }
